    ...
    <tr>
      <td align="center" style="padding:32px 16px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
          style="max-width:600px; background:#1f2937; border-radius:16px; overflow:hidden; box-shadow:0 6px 18px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#6CB12E; padding:24px;" align="left">
              <div style="display:flex; align-items:center; gap:10px;">
                <a>
                  <img src="https://sistema-asistencia-motos-14s5.vercel.app/Logo.png" alt="Sistema Mototaxis Logo"
                    width="80" height="60" style="display:block; object-fit:cover;">
                </a>
          ...
          <tr>
            <td style="padding:32px 24px 20px 24px; font-family:Arial, Helvetica, sans-serif;">
              ...
              <p style="margin:0 0 18px 0; font-size:15px; line-height:1.6; color:#d1d5db;">
                Hemos recibido una solicitud para restablecer tu contraseña de Sistema Mototaxis. Para continuar, haz
                clic en el botón:
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:20px 0;">
                <tr>
                  <td align="center" bgcolor="#8c00c4ff" style="border-radius:10px;">
                    <a href="{{enlace}}"
                      style="display:inline-block; padding:14px 24px; font-family:Arial, Helvetica, sans-serif; font-size:15px; color:#ffffff; text-decoration:none; font-weight:bold;">
              ...
              <p
                style="margin:4px 0 0 0; font-family:Consolas, 'Courier New', monospace; font-size:12px; line-height:1.6; color:#FFB800; word-break:break-all;">
                {{enlace}}
              </p>

              <!-- Notice -->
              <div
                style="margin:22px 0 0 0; padding:14px; background:#111827; border:1px solid #ff0000ff; border-radius:12px;">
